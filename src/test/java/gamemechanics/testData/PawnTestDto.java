...
public class PawnTestDto {    private List<Piece> initialPiecePlacement = new ArrayList<>();
    ...
    private final Piece blackBishop1 = new Bishop(BLACK,D6);
    ...
    private final Piece whitePawn4 = new Pawn(WHITE,D3);
